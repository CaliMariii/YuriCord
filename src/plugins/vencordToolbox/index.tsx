...
function YuricordPopout(onClose: () => void) {
...
function YuricordPopoutIcon(isShown: boolean) {
    return (
...
function YuricordPopoutButton() {
    ...
    return (
        <Popout
            ...
            renderPopout={() => YuricordPopout(() => setShow(false))}
        >
            {(_, { isShown }) => (
                <HeaderBarIcon
                    className="vc-toolbox-btn"
                    onClick={() => setShow(v => !v)}
                    tooltip={isShown ? null : "Yuricord Toolbox"}
                    icon={() => YuricordPopoutIcon(isShown)}
                    selected={isShown}
                />
            )}
        </Popout>
