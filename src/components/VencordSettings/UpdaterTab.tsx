...
function Updater() {
    ...
    return (
        <SettingsTab title="Yuricord🌸 Updater">
            <Forms.FormTitle tag="h5">Updater Settings</Forms.FormTitle>
            <Switch
                value={settings.autoUpdate}
                onChange={(v: boolean) => settings.autoUpdate = v}
                note="Automatically update Yuricord🌸 without confirmation prompt"
            >
            ...
            <Switch
                ...
                note="Shows a notification when Yuricord🌸 automatically updates"
