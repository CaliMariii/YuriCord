...
console.log("[Yuricord] Starting up...");
...
if (!IS_VANILLA) {
    ...
    class BrowserWindow extends electron.BrowserWindow {
        constructor(options: BrowserWindowConstructorOptions) {
            if (options?.webPreferences?.preload && options.title) {
                ...
                options.webPreferences.preload = join(__dirname, IS_DISCORD_DESKTOP ? "preload.js" : "YuricordDesktopPreload.js");
    ...
    process.env.DATA_DIR = join(app.getPath("userData"), "..", "Yuricord");
    ...
    console.log("[Yuricord] Running in vanilla mode. Not loading Yuricord");
}
