...
import { Settings } from "../src/Yuricord";
...
const setCssDebounced = debounce((css: string) => YuricordNative.quickCss.set(css));
...
window.YuricordNative = {
    ...
    settings: {
        ...
        set: async (s: Settings) => localStorage.setItem("YuricordSettings", JSON.stringify(s)),
