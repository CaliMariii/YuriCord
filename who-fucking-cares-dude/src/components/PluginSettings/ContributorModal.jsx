...
function ContributorModal({ user }) {
    useSettings();
    ...
    const ContributedHyperLink = <Link href="https://Yuricord.dev/source">contributed</Link>;
    return (<>
            ...
            {plugins.length ? (<Forms.FormText>
                    ...
                    This person has not made any plugins. They likely {ContributedHyperLink} to Yuricord in other ways!
                </Forms.FormText>)}
