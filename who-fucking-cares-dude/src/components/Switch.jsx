...
export function Switch({ checked, onChange, disabled }) {
    return (<div>
            ...
            opacity: disabled ? 0.3 : 1
                ...
                <svg className={SwitchClasses.slider + " vc-switch-slider"} viewBox="0 0 28 20" preserveAspectRatio="xMinYMid meet" aria-hidden="true" style={{
            transform: checked ? "translateX(12px)" : "translateX(-3px)",
                ...
                <input disabled={disabled} type="checkbox" className={SwitchClasses.input} tabIndex={0} checked={checked} onChange={e => onChange(e.currentTarget.checked)}/>
            </div>
        </div>);
}
