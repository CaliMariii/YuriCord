...
function Layer({ mode, baseLayer = false, ...props }) {
    ...
    const node = (<div ref={containerRef} aria-hidden={hidden} className={cl({
            [Classes.layer]: true,
        ...
        },
        {
            ...
            replacement: [
                ...
                },
                {
                    ...
                    replace: "$&case 'YuricordPlugins':return $self.PluginsSubmenu();"
                }
            ]
        },
    ],
        ...
        return {
            ...
            map(render) {
                return items
                    ...
                    if (label) {
                        return (<Menu.MenuItem key={label} id={label.replace(/\W/, "_")} label={label} action={children[0].props.action}>
                                    {children}
                                </Menu.MenuItem>);
                    }
                    else {
