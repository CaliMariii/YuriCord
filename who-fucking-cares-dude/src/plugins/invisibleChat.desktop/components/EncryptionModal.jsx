...
function EncModal(props) {
    ...
    return (<ModalRoot {...props}>
            ...
            setPassword(e);
                ...
                <Switch value={noCover} onChange={(e) => {
            setNoCover(e);
        }}>
                    Don't use a Cover
                </Switch>
            ...
            <ModalFooter>
                <Button color={Button.Colors.GREEN} disabled={!isValid} onClick={() => {
            if (!isValid)
                return;
            ...
            props.onClose();
                ...
                <Button color={Button.Colors.TRANSPARENT} look={Button.Looks.LINK} style={{ left: 15, position: "absolute" }} onClick={() => {
            props.onClose();
        }}>
                    Cancel
                </Button>
