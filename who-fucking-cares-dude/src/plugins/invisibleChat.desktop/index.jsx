...
function PopOverIcon() {
    return (<svg fill="var(--header-secondary)" width={24} height={24} viewBox={"0 0 64 64"}>
...
const ChatBarIcon = ({ isMainChat }) => {
    ...
    return (<ChatBarButton tooltip="Encrypt Message" onClick={() => buildEncModal()} buttonProps={{
            ...
            <svg aria-hidden role="img" width="24" height="24" viewBox={"0 0 64 64"} style={{ scale: "1.39", translate: "0 -1px" }}>
...
export default definePlugin({
    ...
    URL_REGEX: new RegExp(/(http(s)?:\/\/.)?(www\.)?[-a-zA-Z0-9@:%._+~#=]{2,256}\.[a-z]{2,6}\b([-a-zA-Z0-9@:%_+.~#?&//=]*)/),
    async start() {
    ...
    async buildEmbed(message, revealed) {
