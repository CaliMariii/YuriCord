...
export function buildSeveralUsers({ a, b, count }) {
    return [
...
const TypingUser = ErrorBoundary.wrap(function ({ user, guildId }) {
    return (<strong role="button" onClick={() => {
            ...
            {settings.store.showAvatars && (<div style={{ marginTop: "4px" }}>
                    <Avatar size="SIZE_16" src={user.getAvatarURL(guildId, 128)}/>
                </div>)}
