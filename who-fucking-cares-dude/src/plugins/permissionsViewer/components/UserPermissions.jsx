...
const { RoleRootClasses, RoleClasses, RoleBorderClasses } = proxyLazyWebpack(() => {
    const [RoleRootClasses, RoleClasses, RoleBorderClasses] = findBulk(filters.byProps("root", "expandButton", "collapseButton"), filters.byProps("role", "roleCircle", "roleName"), filters.byProps("roleCircle", "dot", "dotBorderColor"));
...
function FakeRole({ text, color, ...props }) {
    return (<div {...props} className={classes(RoleClasses.role)}>
            <div className={RoleClasses.roleRemoveButton}>
                <span className={classes(RoleBorderClasses.roleCircle, RoleClasses.roleCircle)} style={{ backgroundColor: color }}/>
            </div>
            <div className={RoleClasses.roleName}>
                <Text className={RoleClasses.roleNameOverflow} variant="text-xs/medium">
                    {text}
                </Text>
            </div>
        </div>);
...
function UserPermissionsComponent({ guild, guildMember, closePopout }) {
    ...
    return <div>
        ...
        {userPermissions.length > 0 && (<div className={classes(RoleRootClasses.root)}>
