...
export default definePlugin({
    ...
    getGuildTree(isBetterFolders, originalTree, expandedFolderIds) {
        return useMemo(() => {
            ...
            newTree.nodes = Object.fromEntries(Object.entries(originalTree.nodes)
                .filter(([_, guildOrFolder]) => expandedFolderIds.has(guildOrFolder.id) || expandedFolderIds.has(guildOrFolder.parentId)));
            return newTree;
    ...
    makeGuildsBarTreeFilter(isBetterFolders) {
        return child => {
            if (!isBetterFolders)
                return true;
