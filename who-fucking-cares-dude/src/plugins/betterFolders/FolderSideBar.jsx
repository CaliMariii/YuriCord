...
export default ErrorBoundary.wrap(guildsBarProps => {
    ...
    const Sidebar = (<GuildsBar {...guildsBarProps} isBetterFolders={true} betterFoldersExpandedIds={expandedFolders}/>);
    ...
    return (<Animations.Transition items={visible} from={{ width: 0 }} enter={{ width: guilds.getBoundingClientRect().width }} leave={{ width: 0 }} config={{ duration: 200 }}>
            {(animationStyle, show) => show && (<Animations.animated.div style={{ ...animationStyle, ...barStyle }}>
                        {Sidebar}
