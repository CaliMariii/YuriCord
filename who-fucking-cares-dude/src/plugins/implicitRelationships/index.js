...
export default definePlugin({
    ...
    async fetchImplicitRelationships() {
        ...
        const userAffinities = UserAffinitiesStore.getUserAffinitiesUserIds();
        const nonFriendAffinities = Array.from(userAffinities).filter(id => !RelationshipStore.getRelationshipType(id));
        ...
        const dmUserIds = new Set(Object.values(ChannelStore.getSortedPrivateChannels()).flatMap(c => c.recipients));
