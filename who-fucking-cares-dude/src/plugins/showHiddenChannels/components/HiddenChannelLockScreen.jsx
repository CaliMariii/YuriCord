...
function HiddenChannelLockScreen({ channel }) {
    ...
    return (<div className={ChatScrollClasses.auto + " " + ChatScrollClasses.customTheme + " " + ChatClasses.chatContent + " " + "shc-lock-screen-outer-container"}>
            <div className="shc-lock-screen-container">
                ...
                <div className="shc-lock-screen-heading-container">
                    ...
                    {channel.isNSFW() &&
            <Tooltip text="NSFW">
                            {({ onMouseLeave, onMouseEnter }) => (<svg onMouseLeave={onMouseLeave} onMouseEnter={onMouseEnter} className="shc-lock-screen-heading-nsfw-icon" width="32" height="32" viewBox="0 0 48 48" aria-hidden={true} role="img">
                ...
                {(!channel.isGuildVoice() && !channel.isGuildStageVoice()) && (<Text variant="text-lg/normal">
                ...
                {channel.isForumChannel() && topic && topic.length > 0 && (<div className="shc-lock-screen-topic-container">
            ...
            <Text variant="text-md/normal">Video quality mode: {VideoQualityModesToNames[videoQualityMode ?? 1 /* VideoQualityModes.AUTO */]}</Text>}
            ...
            <div className="shc-lock-screen-tags-container">
                ...
                <div className="shc-lock-screen-allowed-users-and-roles-container">
                    <div className="shc-lock-screen-allowed-users-and-roles-container-title">
                        {Settings.plugins.PermissionsViewer.enabled && (<Tooltip text="Permission Details">
                                {({ onMouseLeave, onMouseEnter }) => (<button onMouseLeave={onMouseLeave} onMouseEnter={onMouseEnter} className="shc-lock-screen-allowed-users-and-roles-container-permdetails-btn" onClick={() => openRolesAndUsersPermissionsModal(permissions, GuildStore.getGuild(channel.guild_id), channel.name)}>
                        ...
                        <Tooltip text={defaultAllowedUsersAndRolesDropdownState ? "Hide Allowed Users and Roles" : "View Allowed Users and Roles"}>
                            {({ onMouseLeave, onMouseEnter }) => (<button onMouseLeave={onMouseLeave} onMouseEnter={onMouseEnter} className="shc-lock-screen-allowed-users-and-roles-container-toggle-btn" onClick={() => settings.store.defaultAllowedUsersAndRolesDropdownState = !defaultAllowedUsersAndRolesDropdownState}>
