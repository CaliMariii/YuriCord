...
export const settings = definePluginSettings({
    ...
    showMode: {
        ...
        options: [
            { label: "Plain style with Lock Icon instead", value: 0 /* ShowMode.LockIcon */, default: true },
            { label: "Muted style with hidden eye icon on the right", value: 1 /* ShowMode.HiddenIconWithMutedStyle */ },
        ],
        restartNeeded: true
    },
...
export default definePlugin({
    ...
    patches: [
        ...
        },
        {
            ...
            predicate: () => settings.store.showMode === 1 /* ShowMode.HiddenIconWithMutedStyle */,
            replacement: [
            ...
            replacement: [
                {
                    ...
                    predicate: () => settings.store.hideUnreads === false && settings.store.showMode === 1 /* ShowMode.HiddenIconWithMutedStyle */,
            ...
            replacement: [
                {
                    ...
                    replace: (m, channel, permCheck) => `${m}!Yuricord.Webpack.Common.PermissionStore.can(${CONNECT}n,${channel})?${permCheck}CONNECT):`
                },
                {
    ...
    LockIcon: ErrorBoundary.wrap(() => (<svg className={ChannelListClasses.icon} height="18" width="20" viewBox="0 0 24 24" aria-hidden={true} role="img">
    ...
    HiddenChannelIcon: ErrorBoundary.wrap(() => (<Tooltip text="Hidden Channel">
            {({ onMouseLeave, onMouseEnter }) => (<svg onMouseLeave={onMouseLeave} onMouseEnter={onMouseEnter} className={ChannelListClasses.icon + " " + "shc-hidden-channel-icon"} width="24" height="24" viewBox="0 0 24 24" aria-hidden={true} role="img">
