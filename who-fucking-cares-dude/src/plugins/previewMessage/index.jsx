...
const getAttachments = async (channelId) => await Promise.all(UploadStore.getUploads(channelId, DraftType.ChannelMessage)
    .map(async (upload) => {
...
const PreviewButton = ({ isMainChat, isEmpty, type: { attachments } }) => {
    ...
    if (!hasContent && !hasAttachments)
        return null;
    return (<ChatBarButton tooltip="Preview Message" onClick={async () => sendBotMessage(channelId, {
            ...
            <svg fill="currentColor" fillRule="evenodd" width="24" height="24" viewBox="0 0 24 24" style={{ scale: "1.096", translate: "0 -1px" }}>
