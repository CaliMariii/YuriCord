...
export default definePlugin({
    ...
    customSections: [],
    makeSettingsCategories(SectionTypes) {
        return [
            {
    ...
    isRightSpot({ header, settings }) {
        ...
        if (settingsLocation === "bottom")
            return firstChild === "LOGOUT";
    ...
    makeInfoElements(Component, props) {
        return this.getInfoRows().map((text, i) => <Component key={i} {...props}>{text}</Component>);
    }
});
