...
function toggleHoverControls(value) {
...
export default definePlugin({
    ...
    patches: [
        {
            ...
            replacement: {
                ...
                // react.jsx(WrapperComponent, { YuricordOriginal: AccountPanel, ...
                replace: "$self.PanelWrapper,{YuricordOriginal:$1,"
            }
        },
        {
            find: ".PLAYER_DEVICES",
    ...
    PanelWrapper({ YuricordOriginal, ...props }) {
        return (<>
                <ErrorBoundary fallback={() => (<div className="vc-spotify-fallback">
