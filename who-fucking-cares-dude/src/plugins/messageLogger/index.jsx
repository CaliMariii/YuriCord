...
const patchMessageContextMenu = (children, props) => {
    ...
    children.push((<Menu.MenuItem id={REMOVE_HISTORY_ID} key={REMOVE_HISTORY_ID} label="Remove Message History" color="danger" action={() => {
            if (deleted) {
...
export function parseEditContent(content, message) {
...
export default definePlugin({
    ...
    renderEdits: ErrorBoundary.wrap(({ message: { id: messageId, channel_id: channelId } }) => {
        ...
        return Settings.plugins.MessageLogger.inlineEdits && (<>
                {message.editHistory?.map((edit, idx) => (<div key={idx} className="messagelogger-edited">
        ...
        },
        {
            ...
            replacement: [
                ...
                },
                {
                    ...
                    replace: "$1deleted: arguments[0]?.deleted," +
                        "spoiler:"
                }
            ]
        },
