            ...
            <form onSubmit={onSave}>
                <ModalContent className={cl("content")}>
                    ...
                    <Forms.FormSection>
                        ...
                        <ColorPickerWithSwatches key={category.id} defaultColor={DEFAULT_COLOR} colors={SWATCHES} onChange={c => setColor(c)} value={color} renderDefaultButton={() => null} renderCustomButton={() => (<ColorPicker color={color} onChange={c => setColor(c)} key={category.id} showEyeDropper={false}/>)}/>
                    </Forms.FormSection>
                </ModalContent>
                <ModalFooter>
