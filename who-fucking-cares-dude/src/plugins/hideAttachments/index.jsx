...
export default definePlugin({
    ...
    renderMessagePopoverButton(msg) {
        ...
        const hasAttachmentsInShapshots = msg.messageSnapshots.some((snapshot) => snapshot?.message.attachments.length);
        if (!msg.attachments.length && !msg.embeds.length && !msg.stickerItems.length && !hasAttachmentsInShapshots)
            return null;
