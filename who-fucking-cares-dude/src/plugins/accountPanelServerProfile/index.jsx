...
const AccountPanelContextMenu = ErrorBoundary.wrap(() => {
    ...
    return (<Menu.Menu navId="vc-ap-server-profile" onClose={ContextMenuApi.closeContextMenu}>
            <Menu.MenuItem id="vc-ap-view-alternate-popout" label={prioritizeServerProfile ? "View Account Profile" : "View Server Profile"} disabled={getCurrentChannel()?.getGuildId() == null} action={e => {
...
export default definePlugin({
    ...
    UserProfile: ErrorBoundary.wrap(({ popoutProps, currentUser, originalRenderPopout }) => {
        ...
        return (<div className={styles.accountProfilePopoutWrapper}>
