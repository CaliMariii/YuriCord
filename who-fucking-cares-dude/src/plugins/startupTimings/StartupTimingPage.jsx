...
function TimingSection({ title, logs, traceEnd }) {
    ...
    return (<Forms.FormSection title={title} tag="h1">
            <code>
                {traceEnd && (<div style={{ color: "var(--header-primary)", marginBottom: 5, userSelect: "text" }}>
...
function ServerTrace({ trace }) {
    ...
    return (<Forms.FormSection title="Server Trace" tag="h2">
            <code>
