...
function CreateDecorationModal(props) {
    ...
    return <ModalRoot {...props} size={"medium" /* ModalSize.MEDIUM */} className={DecorationModalStyles.modal}>
        ...
        <ModalContent className={cl("create-decoration-modal-content")} scrollbarType="none">
            <ErrorBoundary>
        ...
        }} disabled={!file || !name} submitting={submitting}>
                Submit for Review
            </Button>
