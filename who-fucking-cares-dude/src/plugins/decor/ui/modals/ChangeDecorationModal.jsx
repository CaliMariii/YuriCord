...
import { closeAllModals, ModalCloseButton, ModalContent, ModalFooter, ModalHeader, ModalRoot, openModal } from "@utils/modal";
...
function ChangeDecorationModal(props) {
    ...
    return <ModalRoot {...props} size={"dynamic" /* ModalSize.DYNAMIC */} className={DecorationModalStyles.modal}>
        ...
        <ModalContent className={cl("change-decoration-modal-content")} scrollbarType="none">
            ...
            if (typeof item === "string") {
                ...
                <div className={cl("change-decoration-modal-preview")}>
                    <AvatarDecorationModalPreview avatarDecorationOverride={avatarDecorationOverride} user={UserStore.getCurrentUser()}/>
            ...
            <Text variant="text-sm/semibold" color="header-primary">
                    ...
                    {activeDecorationHasAuthor && (<Text key={`createdBy-${activeSelectedDecoration.authorId}`}>
