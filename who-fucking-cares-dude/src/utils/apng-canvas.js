...
!(function i(o, a, s) {
                ...
                (t = this),
                    (e = function () {
                        ...
                        var n = Array.isArray
                            ...
                            }, r = 0, e = void 0, i = void 0, a = function (t, e) {
                            (l[r] = t),
                                (l[r + 1] = e),
                                2 === (r += 2) && (i ? i(d) : g());
                        };
                        var t = "undefined" != typeof window
                            ? window
                            : void 0, o = t || {}, s = o.MutationObserver ||
                            o.WebKitMutationObserver, c = "undefined" == typeof self &&
                            void 0 !== G &&
                            "[object process]" === {}.toString.call(G), f = "undefined" != typeof Uint8ClampedArray &&
                        ...
                        function b() { }
                        var E = void 0, P = 1, x = 2;
                        function N(t, r, i) {
                            a(function (e) {
                                var n = !1, t = (function (t, e, n, r) {
                                    try {
                                        t.call(e, n, r);
                                    }
                                    catch (t) {
                        ...
                        function L(t, e, n, r) {
                            var i = u(n), o = void 0, a = void 0, s = !0;
                            if (i) {
                                try {
                                    o = n(r);
                                }
                                ...
                                if (e === o)
                                    return void R(e, new TypeError("A promises callback cannot return that same promise."));
                            }
                            else
                                o = r;
                            e._state !== E ||
                    ...
                    "object" == typeof r && void 0 !== n
                        ...
                        : "function" == typeof define && define.amd
                            ? define(e)
                            : (t.ES6Promise = e());
            }).call(this, Y("VCmEsw"), "undefined" != typeof self
                ? self
    ...
    2: [
        function (t, e, n) {
            ...
            function i() { }
            (r.nextTick = (function () {
                var t = "undefined" != typeof window && window.setImmediate, e = "undefined" != typeof window &&
                    window.postMessage &&
    ...
    3: [
        function (t, e, n) {
            ...
            e.exports = function () {
                ...
                var r = this, i = 0, o = 0, a = null, s = !1, u = !1, c = [], e = function (t) {
                    for (; s && i <= t;)
                        n(t);
                    s && requestAnimationFrame(e);
                }, n = function (t) {
                    var e = o++ % r.frames.length, n = r.frames[e];
                    if (0 == r.numPlays ||
                        ...
                        for (0 == e &&
                            ...
                            (a = n).iData = null,
                            2 == a.disposeOp &&
                                (a.iData = c[0].getImageData(n.left, n.top, n.width, n.height)),
                            0 == n.blendOp &&
                                c.forEach(function (t) {
    ...
    5: [
        function (a, t, e) {
            (function (t) {
                "use strict";
                var e = a("./support-test"), n = a("./parser"), r = a("./loader"), i = (t.APNG = {});
                ...
                (i.parseURL = function (t) {
                    ...
                    (i.animateImage = function (s) {
                        return (s.setAttribute("data-is-apng", "progress"),
                            i.parseURL(s.src).then(function (t) {
                                ...
                                "" != s.style.width &&
                                    ...
                                    "" != n &&
                                        ...
                                        ((i = parseFloat(n)),
                                            (o = n.match(/\D+$/)[0]),
                                            (r =
                                                Math.round((e.height * i) / e.width) + o)),
                                    "" != r &&
                                        "" == n &&
                                        ((i = parseFloat(r)),
                                            (o = r.match(/\D+$/)[0]),
                                            (n =
                                                Math.round((e.width * i) / e.height) + o)),
                                    (e.style.width = n),
                                    (e.style.height = r);
                                var a = s.parentNode;
                                a.insertBefore(e, s),
    ...
    7: [
        function (t, e, n) {
            "use strict";
            var r = r || t("es6-promise").Promise, m = t("./animation"), o = t("./crc32"), g = new Uint8Array([137, 80, 78, 71, 13, 10, 26, 10]);
                    ...
                    if ((w(A, function (t) {
                        ...
                        if ((w(A, function (t, e, n, r) {
                            switch (t) {
                                ...
                                case "fdAT":
                                    c &&
                                        c.dataParts.push(e.subarray(n + 8 + 4, n + 8 + r));
                                    break;
                                case "IDAT":
                                    c &&
                                        c.dataParts.push(e.subarray(n + 8, n + 8 + r));
                                    break;
                                case "IEND":
                                    s.push(E(e, n, 12 + r));
                                    break;
            ...
            var w = function (t, e) {
                var n = 8;
                do {
                    var r = y(t, n), i = a(t, n + 4, 4), o = e(i, t, n, r);
                    n += 12 + r;
                ...
                var n = t.length + e.length, r = new Uint8Array(new ArrayBuffer(n + 8));
                r.set(P(e.length), 0),
                    r.set((function (t) {
    ...
    8: [
        function (o, a, t) {
            (function (t) {
                "use strict";
                var e, n, r = r || o("es6-promise").Promise, i = ((e = function (e) {
